...
<!--Это задний слой - он и будет изменяться-->
	<svg id="roomSVG" data-name="Слой 3 + Группа 1 Изображение" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 409.7">
		...
		<polygon class="classSVG default" id="block1" fill="url(#imageblock1)" points="209.6,155.5 163.4,157.1 163.4,74.8 209.6,70.4 "/>
		<polygon class="classSVG default" id="block2" fill="url(#imageblock2)" points="306.1,152.1 209.6,155.3 209.6,70.5 306.1,61.4 "/>
		<polygon class="classSVG default" id="block3" fill="url(#imageblock3)" points="493.6,44.2 493.6,145.4 373,149.5 372.7,55.2 "/>
		<polygon class="classSVG default" id="block4" fill="url(#imageblock4)" points="493.6,44.2 493.6,145.4 563.8,143 563.8,37.2 "/>
		<polygon class="classSVG default" id="block5" fill="url(#imageblock5)" points="145.4,243.7 290.8,247.4 290.8,293.9 145.3,285.5 "/>
		<polygon class="classSVG default" id="block6" fill="url(#imageblock6)" points="361.1,249.2 558.3,254.6 558.3,309.2 361.1,297.9 "/>
		<polygon class="classSVG default" id="block7" fill="url(#imageblock7)" points="290.8,293.9 145.3,285.5 145.3,328.1 290.8,340.9 "/>
		<polygon class="classSVG default" id="block8" fill="url(#imageblock8)" points="361.1,297.9 558.3,309.2 558.4,365 361,347.2 "/>
	</svg>
...
<!--Это передний слой - он отслеживает клики и меняет задний слой-->
	...
	<div id="default-hash" data-hash="3,3,3,3,3,3,3,3" data-countSVG="8" data-countTextures="3"></div>
	...
	<script type="text/javascript">
    	...
    	$(document).ready(function()
    	{
			...
			/* --------------------------- */
			var block1 = new areaSVG($('#block1'), $('#clipping1 circle'), 100);
			var block2 = new areaSVG($('#block2'), $('#clipping2 circle'), 135);
			var block3 = new areaSVG($('#block3'), $('#clipping3 circle'), 165);
			var block4 = new areaSVG($('#block4'), $('#clipping4 circle'), 135);
			var block5 = new areaSVG($('#block5'), $('#clipping5 circle'), 185);
			var block6 = new areaSVG($('#block6'), $('#clipping6 circle'), 210);
			var block7 = new areaSVG($('#block7'), $('#clipping7 circle'), 200);
			var block8 = new areaSVG($('#block8'), $('#clipping8 circle'), 210);
