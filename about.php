		...
		<div class="b-wide-block">
			<div class="b-slider">
				<div class="b-slide" data-parallax="scroll" data-image-src="i/catalog.jpg" >
					<div class="b-block">
						<h3>Что такое<br>ООО «Томлесдрев»</h3>
					</div>	
				</div>
			</div>
		</div>
	...
	<div class="b b-content">
		<div class="b-wide-block b-margin">
			<div class="b-block">
				...
				<h1 class="b-title">О предприятии</h1>
				<div class="b-text b-70-p">
					<p>ООО «Томлесдрев» - крупнейшее лесоперерабатывающее предприятие Томской области, приоритетным направлением которого является комплексная переработка древесины: производство ДСП и ЛДСП, лесозаготовка, лесопиление.</p>
				</div>
			</div>
		</div>
		<div class="b-wide-block b-transparent">
			<div class="b-full-width-image b-image-block" style="background-image: url('i/about.jpg');">
				<div class="b-block">
					<h3><b>62 000 м<span class="power">2</span></b>производственная площадь</h3>
				</div>
			</div>
		</div>
		<div class="b-wide-block b-margin">
			<div class="b-block b-text">
				<p>История предприятия начинается со времени образования Томского завода ДСП построенного в 1980 году по проекту фирмы "RAUMA REPOLA" (Финляндия).</p>
				<p>Вместе с ООО "Томлесдрев" слаженно работают предприятия - партнеры по лесозаготовке и лесопилению, а так же цех импрегнирования бумаги.</p>
				<p>Рост и высокое качество продукции обеспечено за счет модернизации процесса производства, внедрения современных технологий, профессионализма сотрудников предприятия. Лесосырьевая база обеспечивается собственными лесозаготовками, что обуславливает отсутствие дефицита сырья.</p>
				<p>&nbsp;</p>
				<p>ДСП и ЛДСП производства ООО "Томлесдрев" - это экологичный продукт высокого качества, без посторонних включений. Развитая торговая сеть позволяет реализовывать продукцию на всей территории России и странах СНГ.</p>
			</div>
			<div class="b-block">
				<ul class="b-numbers clearfix">
					<li class="b-number clearfix b-dsp">
						<div class="b-image"></div>
						<div class="b-text-block">
							<h3><b>36 250 000 м<span class="power">2</span></b> в год</h3>
							<h3>производство ДСП</h3>
						</div>
					</li>
					<li class="b-number clearfix b-ldsp">
						<div class="b-image"></div>
						<div class="b-text-block">
							<h3><b>34 000 000 м<span class="power">2</span></b> в год</h3>
							<h3>производство ЛДСП</h3>
						</div>
					</li>
					<li class="b-number clearfix b-paper">
						<div class="b-image"></div>
						<div class="b-text-block">
							<h3><b>70 000 000 м<span class="power">2</span></b> в год</h3>
							<h3>производство импрегнированной бумаги</h3>
						</div>
					</li>
				</ul>
			</div>
