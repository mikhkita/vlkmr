						...
						<div class="floorIMG" data-src="i/FloorHall-1.jpg">
							...
							<defs>
								<pattern id="floorPattern1" width="100%" height="100%">
							        <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="i/FloorHall-1.jpg" x="-10" y="-100" width="1000" height="250">
							     	</image>
							    </pattern>
							</defs>
						...
						<div class="floorIMG" data-src="i/FloorHall-2.jpg">
							...
							<defs>
								<pattern id="floorPattern2" width="100%" height="100%">
							        <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="i/FloorHall-2.jpg" x="-10" y="-100" width="1000" height="250">
							     	</image>
							    </pattern>
							</defs>
						...
						<div class="floorIMG" data-src="i/FloorHall-3.jpg">
							...
							<defs>
								<pattern id="floorPattern3" width="100%" height="100%">
							        <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="i/FloorHall-3.jpg" x="-10" y="-100" width="1000" height="250">
							     	</image>
							    </pattern>
							</defs>
...
<!--Это задний слой - он и будет изменяться-->
	<svg id="roomSVG" data-name="Слой 3 + Группа 1 Изображение" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 432">
		...
		<polygon class="classSVG default" id="blockLeft2" fill="url(#imageblockLeft2)" points="145,344.8 154,335.7 154,296.1 155,296 155.1,295.3 155.2,85.6 145,75.2 "/>
		...
		<rect x="143.5" y="130.3" class="classSVG default" id="blockLeft7" fill="url(#imageblockLeft7)" width="1.5" height="143.7"/>
		...
		<polygon class="classSVG default" id="blockCenter5" fill="url(#imageblockCenter5)" points="359.3,296.2 154,296.1 155,296 155.1,295.3 163.5,290.2 354.2,290.2 "/>
		<polygon class="classSVG default" id="blockCenter6" fill="url(#imageblockCenter6)" points="359.3,296.2 359.3,302.9 319.3,308.7 193.8,308.7 154,302.9 154,296.1 "/>
		...
		<polygon class="classSVG default" id="blockRight4" fill="url(#imageblockRight4)" points="372.2,115.6 365.8,123.4 365.8,334.5 372.2,344.8 "/>
		<rect x="372.2" y="170.4" class="classSVG default" id="blockRight5" fill="url(#imageblockRight5)" width="1.8" height="103.6"/>
		...
		<polygon class="classSVG default" id="floor" fill="url(#floorPattern)" points="25.7,344.8 540,344.8 579.7,364.7 579.7,434.7 -2.3,434.7 -2.3,405 26,389.8 "/>
...
<!--Это передний слой - он отслеживает клики и меняет задний слой-->
	<svg id="roomSVGFront" data-name="Слой 3 + Группа 1 Изображение" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 432">
		...
		<polygon class="classSVGFront" id="floor" points="25.7,344.8 540,344.8 579.7,364.7 579.7,434.7 -2.3,434.7 -2.3,405 26,389.8 "/>
	</svg>
	...
	<script type="text/javascript">
    	$(document).ready(function()
    	{
			...
			var blockLeft7 = new areaSVG($('#blockLeft7'), $('#clippingLeft7 circle'), 100);
			...
			var blockCenter7 = new areaSVG($('#blockCenter7'), $('#clippingCenter7 circle'), 70);
			...
			var blockRight5 = new areaSVG($('#blockRight5'), $('#clippingRight5 circle'), 60);
