	...
	<div class="b b-content">
		<div class="b-wide-block b-margin">
			<div class="b-block">
				...
				<h1 class="b-title">ПРИГЛАШАЕМ К СОТРУДНИЧЕСТВУ</h1>
				<div class="b-text">
					<div class="b-date b-news-detail-date">12 октября 2016</div>
					<p><b>Заводу ДСП, входящему ныне в ЛПК «Томлесдрев», в этом году исполнилось без малого 30 лет. Срок немалый даже для отдельно взятого человека, а для предприятия, которое пережило несколько экономических формаций за свою историю, - и того пуще.</b><br><br>Наша история - это наши люди, - говорит Сергей Венчинович ЛЮ, директор завода ДСП. - Есть такие, кто работает здесь со дня основания. Поговорите хотя бы с несколькими из них, спросите, как изменилось производство, они вам лучше меня расскажут.<br>О себе говорит скупо:<br>- В ноябре будет десять лет, как руковожу заводом.<br>Зато о нём много и охотно рассказывают подчинённые:<br>- Прекрасный специалист, знающий малейшие технологические тонкости, знающий каждого человека на предприятии. Невероятно требовательный, прежде всего к себе, поэтому имеющий моральное право требовать и от других. Хотя, с другой стороны, очень внимательный и чуткий человек. Если у кого-то беда, требуется помощь, поддержка, он всегда готов помочь.</p>
					<img src="i/news-detail.jpg" alt="">
					<h2>Заголовок H2</h2>
					<p>На данном участке происходит измельчение древесины в технологическую щепу и очистка от металлических включений с помощью металлоискателей, после чего щепа поступает в бункер-накопитель и частично складируется складируется на территории завода на отдельном открытом складе.</p>
					<h3>Заголовок h3</h3>
					<p>На данном участке происходит измельчение древесины в технологическую щепу и очистка от металлических включений с помощью металлоискателей, после чего щепа поступает в бункер-накопитель и частично складируется складируется на территории завода на отдельном открытом складе.</p>
					<h3>Заголовок h3</h3>
					<ul>
					...
					<table>
						...
						<tr>
							<td>На данном участке происходит измельчение древесины в технологическую щепу и очистка от металли</td>
							<td>Текст</td>
							<td>На данном участке про исходит измоисходит измельчение древесины в технологическую щепу и очистка от металли щепу и очистка от металли</td>
							<td>Текст</td>
						</tr>
						<tr>
							<td>Текст</td>
					...
					<h3>Заголовок к файлам (h3)</h3>
					<div class="b-cols b-3-cols">
						<div class="b-col"><img src="i/news-detail.jpg" alt=""></div>
						<div class="b-col"><img src="i/news-detail.jpg" alt=""></div>
						<div class="b-col"></div>
					</div>
					<p>На данном участке происходит измельчение древесины в технологическую щепу и очистка от металлических включений с помощью металлоискателей, после чего щепа поступает в бункер-накопитель и частично складируется складируется на территории завода на отдельном открытом складе.</p>
					...
					<div class="clearfix">
						<a href="news.php" class="b-return-link">Все новости</a>
					</div>
				</div>
			</div>
		</div>
