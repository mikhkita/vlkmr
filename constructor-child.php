...
<!--Конструктор-->
		...
		<div class="panelFloor">
						...
						<div class="b-floor-cont">
							...
							<polygon class="classSVGback block1BackSmall" fill="" points="116.3,174.7 239,128.3 241.9,1460.2 127,1406.8 "/>
							<polygon class="classSVGback block2BackSmall" fill="" points="239,128.3 722.7,191 722.7,212 239,153.7 "/>
							<polygon class="classSVGback block3BackSmall" fill="" points="241.9,1460.2 718.7,1380.3 720.8,1351.1 248,1425.8 241.9,1422.5 "/>
							<polygon class="classSVGback block4BackSmall" fill="" points="239,153.7 490.3,184 491.5,485.5 239.8,472.2 "/>
							<polygon class="classSVGback block5BackSmall" fill="" points="490.3,184 715.5,212 716.2,496.5 491.5,485.5 "/>
							<polygon class="classSVGback block6BackSmall" fill="" points="239.8,472.2 491.5,485.5 493.8,787 241.9,791.8 "/>
							<polygon class="classSVGback block7BackSmall" fill="" points="491.5,485.5 716.2,496.5 717.7,782.5 493.8,787 "/>
							<polygon class="classSVGback block8BackSmall" fill="" points="241.9,791.8 493.8,787 495.3,1088 241.9,1110.7 "/>
							<polygon class="classSVGback block9BackSmall" fill="" points="493.8,787 717.7,782.5 719.7,1068.3 495.3,1088 "/>
							<polygon class="classSVGback block10BackSmall" fill="" points="241.9,1110.7 495.3,1088 497.5,1386.4 248,1425.8 244.5,1423.9 "/>
							<polygon class="classSVGback block11BackSmall" fill="" points="495.3,1088 719.7,1068.3 720.8,1351.1 497.5,1385.5 "/>

							<polygon class="classSVGback block12BackSmall" fill="" points="719.5,1041.7 788.2,1036.1 891,1050.4 891,1068.3 887.3,1069.3 719.7,1082.6 "/>
							<polygon class="classSVGback block13BackSmall" fill="" points="719.7,1081.3 887.3,1066.5 887.3,1140 720,1159.3 "/>
							<polygon class="classSVGback block14BackSmall" fill="" points="887.3,1140 889.2,1213.5 720.4,1235.8 720,1159.3 "/>
							<polygon class="classSVGback block15BackSmall" fill="" points="889.2,1213.5 889.2,1287.3 720.7,1313.8 720.4,1235.8 "/>
							<polygon class="classSVGback block16BackSmall" fill="" points="722.1,1329.1 720.7,1313.8 889.2,1287.3 892,1286.8 891.6,1296 891.7,1301.9 "/>

							<polygon class="classSVGback block17BackSmall" fill="" points="1237.1,1028.2 1109.8,1014.2 1096.2,1015.6 1096.2,1245 1225.1,1271.4 1232.7,1271.4 1231.6,1029.1 "/>
							<polygon class="classSVGback block18BackSmall" fill="" points="1399,323.3 1100.7,288.7 1095,290.7 1094.5,961.9 1101.9,961.9 1399.3,943 "/>
							<polygon class="classSVGback block19BackSmall" fill="" points="2251.1,911.6 1960.6,933.7 1959,1047 1973,1047 2266.7,1013.3 2266.7,913.7 "/>
							<path class="classSVGback block20BackSmall" fill="" d="M1534.2,922.2V883c0,0,109.8-127,320.8-125s411.7,155.7,411.7,155.7l-15.6-2l-290.4,22L1534.2,922.2z"/>
							<polygon class="classSVGback block21BackSmall" fill="" points="1260.5,1034 1260.5,1165.7 1271.7,1167.8 1271.7,1172 1267.5,1172.4 1267.3,1271.4 1248.1,1271.4 
								1248.1,1034 "/>
							<polygon class="classSVGback block22BackSmall" fill="" points="1942.8,1103.7 1942.8,1271 1943.5,1400.9 1963.1,1402.1 1960.2,1103.7 "/>
							<polygon class="classSVGback block23BackSmall" fill="" points="1260.5,1034 1942.8,1103.7 1942.8,1271 1271.7,1167.8 1260.5,1165.7 "/>
							<polygon class="classSVGback block24BackSmall" fill="" points="1271.7,1172 1942.8,1272.3 1942.8,1418.3 1265.8,1285.5 1267.5,1172.4 "/>
...
<pattern id="imageblock1" width="100%" height="100%">
		       <image class="defaultRand" data-number="1" rand-min-x="-500" rand-max-x="0" rand-min-y="-200" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-200" y="-100" width="1000" height="1600" transform="scale(0.5, 1)">
		     	</image>
		    </pattern>
		    <pattern id="imageblock2" width="100%" height="100%">
		       <image class="defaultRand" data-number="2" rand-min-x="-500" rand-max-x="0" rand-min-y="-200" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="0" y="0" width="600" height="960" transform="rotate(98, 300, 300)">
		     	</image>
		    </pattern>
		    <pattern id="imageblock3" width="100%" height="100%">
		       <image class="defaultRand" data-number="3" rand-min-x="-500" rand-max-x="0" rand-min-y="-200" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="0" y="0" width="600" height="960" transform="rotate(82, 300, 300)">
		     	</image>
		    </pattern>
		    <pattern id="imageblock4" width="100%" height="100%">
		       <image class="defaultRand" data-number="4" rand-min-x="-200" rand-max-x="0" rand-min-y="-400" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-30" y="-100" width="500" height="800" >
		     	</image>
		    </pattern>
		    <pattern id="imageblock5" width="100%" height="100%">
		       <image class="defaultRand" data-number="5" rand-min-x="-200" rand-max-x="0" rand-min-y="-400" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-100" y="-50" width="500" height="800" >
		     	</image>
		    </pattern>
		    <pattern id="imageblock6" width="100%" height="100%">
		       <image class="defaultRand" data-number="6" rand-min-x="-200" rand-max-x="0" rand-min-y="-400" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-120" y="-300" width="500" height="800" >
		     	</image>
		    </pattern>
		    <pattern id="imageblock7" width="100%" height="100%">
		       <image class="defaultRand" data-number="7" rand-min-x="-200" rand-max-x="0" rand-min-y="-400" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-150" y="-50" width="500" height="800" >
		     	</image>
		    </pattern>
		    <pattern id="imageblock8" width="100%" height="100%">
		       <image class="defaultRand" data-number="8" rand-min-x="-200" rand-max-x="0" rand-min-y="-400" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-200" y="-350" width="500" height="800" >
		     	</image>
		    </pattern>
		    <pattern id="imageblock9" width="100%" height="100%">
		       <image class="defaultRand" data-number="9" rand-min-x="-200" rand-max-x="0" rand-min-y="-400" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-140" y="-150" width="500" height="800" >
		     	</image>
		    </pattern>
		    <pattern id="imageblock10" width="100%" height="100%">
		       <image class="defaultRand" data-number="10" rand-min-x="-200" rand-max-x="0" rand-min-y="-400" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-50" y="-222" width="500" height="800" >
		     	</image>
		    </pattern>
		    <pattern id="imageblock11" width="100%" height="100%">
		       <image class="defaultRand" data-number="11" rand-min-x="-200" rand-max-x="0" rand-min-y="-400" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-80" y="-120" width="500" height="800" >
		     	</image>
		    </pattern>


		    <pattern id="imageblock12" width="100%" height="100%">
		       <image class="defaultRand" data-number="12" rand-min-x="-120" rand-max-x="0" rand-min-y="-200" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-20" y="0" width="300" height="480" transform="rotate(82, 100, 100)">
		     	</image>
		    </pattern>
		    <pattern id="imageblock13" width="100%" height="100%">
		       <image class="defaultRand" data-number="13" rand-min-x="-120" rand-max-x="0" rand-min-y="-200" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-20" y="0" width="300" height="480" transform="rotate(82, 100, 100)">
		     	</image>
		    </pattern>
		    <pattern id="imageblock14" width="100%" height="100%">
		       <image class="defaultRand" data-number="14" rand-min-x="-120" rand-max-x="0" rand-min-y="-200" rand-max-y="0" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-20" y="-100" width="300" height="480" transform="rotate(82, 100, 100)">
		     	</image>
		    </pattern>
		    <pattern id="imageblock15" width="100%" height="100%">
		       <image class="defaultRand" data-number="15" rand-min-x="-120" rand-max-x="0" rand-min-y="-200" rand-max-y="0" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-20" y="-50" width="300" height="480" transform="rotate(82, 100, 100)">
		     	</image>
		    </pattern>
		    <pattern id="imageblock16" width="100%" height="100%">
		       <image class="defaultRand" data-number="16" rand-min-x="-120" rand-max-x="0" rand-min-y="-200" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-20" y="0" width="300" height="480" transform="rotate(82, 100, 100)">
		     	</image>
		    </pattern>

		    <pattern id="imageblock17" width="100%" height="100%">
		       <image class="defaultRand" data-number="17" rand-min-x="-300" rand-max-x="0" rand-min-y="-400" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-20" y="0" width="500" height="800" >
		     	</image>
		    </pattern>
		    <pattern id="imageblock18" width="100%" height="100%">
		       <image class="defaultRand" data-number="18" rand-min-x="-150" rand-max-x="0" rand-min-y="-250" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-20" y="0" width="600" height="960" >
		     	</image>
		    </pattern>
		    <pattern id="imageblock19" width="100%" height="100%">
		       <image class="defaultRand" data-number="19" rand-min-x="-300" rand-max-x="-20" rand-min-y="-300" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-50" y="0" width="500" height="800" transform="rotate(84, 200, 200)">
		     	</image>
		    </pattern>
		    <pattern id="imageblock20" width="100%" height="100%">
		       <image class="defaultRand" data-number="20" rand-min-x="-500" rand-max-x="0" rand-min-y="-200" rand-max-y="0" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="0" y="0" width="800" height="1280" transform="rotate(95, 400, 400)">
		     	</image>
		    </pattern>
		    <pattern id="imageblock21" width="100%" height="100%">
		       <image class="defaultRand" data-number="21" rand-min-x="-150" rand-max-x="0" rand-min-y="0" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-20" y="0" width="500" height="800" >
		     	</image>
		    </pattern>
		    <pattern id="imageblock22" width="100%" height="100%">
		       <image class="defaultRand" data-number="22" rand-min-x="-150" rand-max-x="0" rand-min-y="0" rand-max-y="0"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-20" y="0" width="500" height="800" >
		     	</image>
		    </pattern>
		    <pattern id="imageblock23" width="100%" height="100%">
		       <image class="defaultRand" data-number="23" rand-min-x="-200" rand-max-x="0" rand-min-y="-150" rand-max-y="-150"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-20" y="-150" width="500" height="800" transform="rotate(98, 300, 300)">
		     	</image>
		    </pattern>
		    <pattern id="imageblock24" width="100%" height="100%">
		       <image class="defaultRand" data-number="24" rand-min-x="-200" rand-max-x="0" rand-min-y="-150" rand-max-y="-150"  xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" x="-20" y="-150" width="500" height="800" transform="rotate(100, 300, 300)">
		     	</image>
		    </pattern>
...
<!--Это задний слой - он и будет изменяться-->
	<svg id="roomSVG" data-name="Слой 3 + Группа 1 Изображение" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2401 1565">
		...
		<polygon class="classSVG default" id="block7" data-clip="clipping7 circle" data-radius="400" fill="url(#imageblock7)" points="491.5,485.5 716.2,496.5 717.7,782.5 493.8,787 "/>
		<polygon class="classSVG default" id="block8" data-clip="clipping8 circle" data-radius="400" fill="url(#imageblock8)" points="241.9,791.8 493.8,787 495.3,1088 241.9,1110.7 "/>
		<polygon class="classSVG default" id="block9" data-clip="clipping9 circle" data-radius="400" fill="url(#imageblock9)" points="493.8,787 717.7,782.5 719.7,1068.3 495.3,1088 "/>
		<polygon class="classSVG default" id="block10" data-clip="clipping10 circle" data-radius="400" fill="url(#imageblock10)" points="241.9,1110.7 495.3,1088 497.5,1386.4 248,1425.8 244.5,1423.9 "/>
		<polygon class="classSVG default" id="block11" data-clip="clipping11 circle" data-radius="400" fill="url(#imageblock11)" points="495.3,1088 719.7,1068.3 720.8,1351.1 497.5,1385.5 "/>


		<polygon class="classSVG default" id="block12" data-clip="clipping12 circle" data-radius="200" fill="url(#imageblock12)" data-coordX="32" data-coordY="68" data-connect="16" points="719.5,1041.7 788.2,1036.1 891,1050.4 891,1068.3 887.3,1069.3 719.7,1082.6 "/>
		<polygon class="classSVG default" id="block13" data-clip="clipping13 circle" data-radius="200" fill="url(#imageblock13)" points="719.7,1081.3 887.3,1066.5 887.3,1140 720,1159.3 "/>
		<polygon class="classSVG default" id="block14" data-clip="clipping14 circle" data-radius="200" fill="url(#imageblock14)" points="887.3,1140 889.2,1213.5 720.4,1235.8 720,1159.3 "/>
		<polygon class="classSVG default" id="block15" data-clip="clipping15 circle" data-radius="200" fill="url(#imageblock15)" points="889.2,1213.5 889.2,1287.3 720.7,1313.8 720.4,1235.8 "/>
		<polygon class="classSVG default" id="block16" data-clip="clipping16 circle" data-radius="200" fill="url(#imageblock16)" data-coordX="34" data-coordY="82" data-connect="12" points="722.1,1329.1 720.7,1313.8 889.2,1287.3 892,1286.8 891.6,1296 891.7,1301.9 "/>

		<polygon class="classSVG default" id="block17" data-clip="clipping17 circle" data-radius="400" fill="url(#imageblock17)" points="1237.1,1028.2 1109.8,1014.2 1096.2,1015.6 1096.2,1245 1225.1,1271.4 1232.7,1271.4 1231.6,1029.1 "/>
		<polygon class="classSVG default" id="block18" data-clip="clipping18 circle" data-radius="800" fill="url(#imageblock18)" points="1399,323.3 1100.7,288.7 1095,290.7 1094.5,961.9 1101.9,961.9 1399.3,943 "/>
		<polygon class="classSVG default" id="block19" data-clip="clipping19 circle" data-radius="350" fill="url(#imageblock19)" points="2251.1,911.6 1960.6,933.7 1959,1047 1973,1047 2266.7,1013.3 2266.7,913.7 "/>
		<path class="classSVG default" id="block20" data-clip="clipping20 circle" data-radius="800" fill="url(#imageblock20)" d="M1534.2,922.2V883c0,0,109.8-127,320.8-125s411.7,155.7,411.7,155.7l-15.6-2l-290.4,22L1534.2,922.2z"/>
		<polygon class="classSVG default" id="block21" data-clip="clipping21 circle" data-radius="800" data-connect="22,23" fill="url(#imageblock21)" points="1260.5,1034 1260.5,1165.7 1271.7,1167.8 1271.7,1172 1267.5,1172.4 1267.3,1271.4 1248.1,1271.4 
			1248.1,1034 "/>
		<polygon class="classSVG default" id="block22" data-clip="clipping22 circle" data-radius="800" data-connect="21,23"  fill="url(#imageblock22)" points="1942.8,1103.7 1942.8,1271 1943.5,1400.9 1963.1,1402.1 1960.2,1103.7 "/>
		<polygon class="classSVG default" id="block23" data-clip="clipping23 circle" data-radius="800" data-connect="22,21"  fill="url(#imageblock23)" points="1260.5,1034 1942.8,1103.7 1942.8,1271 1271.7,1167.8 1260.5,1165.7 "/>
		<polygon class="classSVG default" id="block24" data-clip="clipping24 circle" data-radius="800" fill="url(#imageblock24)" points="1271.7,1172 1942.8,1272.3 1942.8,1418.3 1265.8,1285.5 1267.5,1172.4 "/>
		<polygon id="floor" fill="url(#floorPattern)" points="-6.3,1428.2 130.7,1408.6 241.9,1460.2 718.7,1380.3 722.1,1329.1 891.7,1301.9 891.6,1296 945,1287.4   986.5,1210.4 957,1139.4 1079.5,1140 1055.5,1205.4 1086,1264.9 1106,1261.7 1973,1434 2260,1361 2406,1402.1 2406,1574 -8,1574 "/>

	</svg>

	<img id="room" src="i/RoomChild.png" data-image="i/RoomChild.png" data-retina-image="i/RoomChild.png">
...
<!--Это передний слой - он отслеживает клики и меняет задний слой-->
	<svg id="roomSVGFront" data-name="Слой 3 + Группа 1 Изображение" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2401 1565">
		...
		<polygon class="classSVGFront" id="block7Front" data-id="block7" data-smallTexture=".block7BackSmall" points="491.5,485.5 716.2,496.5 717.7,782.5 493.8,787 "/>
		<polygon class="classSVGFront" id="block8Front" data-id="block8" data-smallTexture=".block8BackSmall" points="241.9,791.8 493.8,787 495.3,1088 241.9,1110.7 "/>
		<polygon class="classSVGFront" id="block9Front" data-id="block9" data-smallTexture=".block9BackSmall" points="493.8,787 717.7,782.5 719.7,1068.3 495.3,1088 "/>
		<polygon class="classSVGFront" id="block10Front" data-id="block10" data-smallTexture=".block10BackSmall" points="241.9,1110.7 495.3,1088 497.5,1386.4 248,1425.8 244.5,1423.9 "/>
		<polygon class="classSVGFront" id="block11Front" data-id="block11" data-smallTexture=".block11BackSmall" points="495.3,1088 719.7,1068.3 720.8,1351.1 497.5,1385.5 "/>

		<polygon class="classSVGFront" id="block12Front" data-id="block12" data-smallTexture=".block12BackSmall, .block16BackSmall" points="719.5,1041.7 788.2,1036.1 891,1050.4 891,1068.3 887.3,1069.3 719.7,1082.6 "/>
		<polygon class="classSVGFront" id="block13Front" data-id="block13" data-smallTexture=".block13BackSmall" points="719.7,1081.3 887.3,1066.5 887.3,1140 720,1159.3 "/>
		<polygon class="classSVGFront" id="block14Front" data-id="block14" data-smallTexture=".block14BackSmall" points="887.3,1140 889.2,1213.5 720.4,1235.8 720,1159.3 "/>
		<polygon class="classSVGFront" id="block15Front" data-id="block15" data-smallTexture=".block15BackSmall" points="889.2,1213.5 889.2,1287.3 720.7,1313.8 720.4,1235.8 "/>
		<polygon class="classSVGFront" id="block16Front" data-id="block16" data-smallTexture=".block16BackSmall, .block12BackSmall" points="722.1,1329.1 720.7,1313.8 889.2,1287.3 892,1286.8 891.6,1296 891.7,1301.9 "/>

		<polygon class="classSVGFront" id="block17Front" data-id="block17" data-smallTexture=".block17BackSmall" points="1237.1,1028.2 1109.8,1014.2 1096.2,1015.6 1096.2,1245 1225.1,1271.4 1232.7,1271.4 1231.6,1029.1 "/>
		<polygon class="classSVGFront" id="block18Front" data-id="block18" data-smallTexture=".block18BackSmall" points="1399,323.3 1100.7,288.7 1095,290.7 1094.5,961.9 1101.9,961.9 1399.3,943 "/>
		<polygon class="classSVGFront" id="block19Front" data-id="block19" data-smallTexture=".block19BackSmall" points="2251.1,911.6 1960.6,933.7 1959,1047 1973,1047 2266.7,1013.3 2266.7,913.7 "/>
		<path class="classSVGFront" id="block20Front" data-id="block20" data-smallTexture=".block20BackSmall" d="M1534.2,922.2V883c0,0,109.8-127,320.8-125s411.7,155.7,411.7,155.7l-15.6-2l-290.4,22L1534.2,922.2z"/>
		<polygon class="classSVGFront" id="block21Front" data-id="block21" data-smallTexture=".block21BackSmall, .block22BackSmall, .block23BackSmall" points="1260.5,1034 1260.5,1165.7 1271.7,1167.8 1271.7,1172 1267.5,1172.4 1267.3,1271.4 1248.1,1271.4 
			1248.1,1034 "/>
		<polygon class="classSVGFront" id="block22Front" data-id="block22" data-smallTexture=".block22BackSmall, .block21BackSmall, .block23BackSmall" points="1942.8,1103.7 1942.8,1271 1943.5,1400.9 1963.1,1402.1 1960.2,1103.7 "/>
		<polygon class="classSVGFront" id="block23Front" data-id="block23" data-smallTexture=".block23BackSmall, .block21BackSmall, .block22BackSmall" points="1260.5,1034 1942.8,1103.7 1942.8,1271 1271.7,1167.8 1260.5,1165.7 "/>
		<polygon class="classSVGFront" id="block24Front" data-id="block24" data-smallTexture=".block24BackSmall" points="1271.7,1172 1942.8,1272.3 1942.8,1418.3 1265.8,1285.5 1267.5,1172.4 "/>
		<polygon class="classSVGFront" id="floorF" data-id="floor" points="-6.3,1428.2 130.7,1408.6 241.9,1460.2 718.7,1380.3 722.1,1329.1 891.7,1301.9 891.6,1296 945,1287.4   986.5,1210.4 957,1139.4 1079.5,1140 1055.5,1205.4 1086,1264.9 1106,1261.7 1973,1434 2260,1361 2406,1402.1 2406,1574 -8,1574 "/>

	
		
	</svg>

	<div id="default-hash" data-hash="1|2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2" data-countSVG="25" data-countTextures="3" data-stack="24"></div>
