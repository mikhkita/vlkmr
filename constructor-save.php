  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $('.textures').slick({
		...
		<svg id="roomSVGBack" data-name="Слой 3 + Группа 1 Изображение" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 540" width="2560" height="2160">
		...
		<!-- <use id="use" xlink:href="#image-test" /> -->
	</svg>
...
<!--Это передний слой - он отслеживает клики и меняет задний слой-->
	...
	<script type="text/javascript">
    	$(document).ready(function()
    	{
			...
			var webpage = document.getElementById('hammerElement');

var mc = new Hammer.Manager(webpage, {
    touchAction: 'auto',
    recognizers: [
...
mc.on("pinch", function (ev) {
    ...
    currentScale = Math.min(adjustScale * ev.scale, 2);
...
mc.on("pinchend", function (ev) {
    ...
    $('.relBackground').css({"height": $('.rel').height() * adjustScale});
			...
			<canvas id="canvas" width="2560" height="2160"></canvas>
