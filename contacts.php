	...
	<div class="b b-content">
		<div class="b-wide-block b-margin">
			<div class="b-block">
				...
				<div class="b-text">
					<div class="b-cols b-4-cols">
						<div class="b-col">
							<h4>Мнококанальный</h4>
							<p>Тел: +7 – (3822)-70-67-27</p>
							<p>&nbsp;</p>
							<h4>Главный офис</h4>
							<p>Тел: +7 - (3822) 70-67-34<br>E-mail: sekretartld@tomlesdrev.ru</p>
						</div>
						<div class="b-col">
							<h4>Отдел сбыта</h4>
							<p>Тел: +7 (3822) 28-33-48<br>Факс: +7 (3822) 70-67-13<br>E-mail: marketing@tomlesdrev.ru</p>
						</div>
						<div class="b-col">
							<h4>Отдел снабжения</h4>
							<p>Тел.: +7 - (3822) 28-33-39<br>Факс.:+7 - (3822) 72-31-13<br>E-mail: omts@tomlesdrev.ru</p>
						</div>
						<div class="b-col">
							<h4>PR</h4>
							<p>Тел.: +7-923-444-70-74<br>E-mail: 4447074@mail.ru<br>Контактное лицо: Боцман Надежда Александровна</p>
						</div>
					</div>
				</div>
				<div class="b-contacts-form b-form">
					<h2 class="b-title">Обратная связь</h2>
					<form action="kitsend.php" method="POST" id="b-contacts-form" data-block="#b-popup-2">
						<div class="b-popup-form clearfix">
							<input type="text" id="name" name="name" placeholder="Имя" required/>
							<input type="text" class="no-margin" id="email" name="email" placeholder="E-mail" required/>
							<input type="text" id="subject" name="subject" placeholder="Тема обращения" required/>
							<textarea name="message" class="no-margin" id="message" placeholder="Сообщение" required></textarea>
							<a href='#' type="submit" class="ajax b-orange-butt" onclick="$('#b-contacts-form').submit(); return false;">Написать</a>
						</div>
					</form>
				</div>
			</div>
		</div>
		<div id="contacts_map" class="b-wide-block b-contacts-map anim map" data-anim="map" data-offset="350" data-func="map"></div>
	</div>
