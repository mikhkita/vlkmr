...
<html>
<head>
	<title>Томлесдрев - крупнейшее лесоперерабатывающее предприятие Томской области</title>
	<meta name="keywords" content='Крупнейшее лесоперерабатывающее предприятие Томской области'>
	<meta name="description" content='Крупнейшее лесоперерабатывающее предприятие Томской области'>
    ...
    <meta property="og:title" content="Томлесдрев - крупнейшее лесоперерабатывающее предприятие Томской области">
    <meta property="og:description" content="Крупнейшее лесоперерабатывающее предприятие Томской области">
    <meta property="og:image" content="i/logo-vk.png">
    <meta property="twitter:image" content="i/logo-vk.png">
    <link rel="image_src" href="i/logo-vk.png">
...
<body class="en">
	...
	<div class="b-fixed-sides">
		<div class="b-fixed-side b-fixed-left">
			<div class="b-fixed-side-item" style="background-image: url('i/blurred2.jpg');"></div>
			<div class="b-fixed-side-item" style="background-image: url('i/blurred.jpg');"></div>
		</div>
		...
		<div class="b-wide-block">
			<div class="b-block clearfix">
				...
				<ul class="b-lang-nav clearfix right">
					<div class="b-lang-p left">Язык:</div>
		...
		<div class="b-wide-block">
			<div class="b-block clearfix">
				...
				<ul class="b-menu b-not-mobile left clearfix">
					...
					<li>
						<a href="catalog.php" class="active">Продукция</a>
						<ul class="b-submenu">
							<li><a href="catalog.php">ЛДСП</a></li>
							<li><a href="styles.php" class="active">ДСП</a></li>
				...
				<a href="#" class="b-mobile b-question-link right">Задать вопрос</a>
			</div>
		</div>
	</div>
	<div class="b b-main-slider">
		<div class="b-wide-block">
			<div class="b-slider">
				<div class="b-slide" style="background-image: url('i/slider-2.jpg');">
					<div class="b-block">
						<h3>Перерабатываем<br><b>500 000 м<sup>3</sup> сырья в год</b></h3>
					</div>	
				</div>
				<div class="b-slide" style="background-image: url('i/slider.jpg');">
					<div class="b-block">
						<h3>Производим<br><b>36 250 000 м<sup>2</sup> ДСП в год</b></h3>
					</div>	
				</div>
			</div>
			<div class="b-slider-nav">
				<span class="b-slider-nav-prev icon icon-arrow-left"></span>
				<span class="b-slider-nav-next icon icon-arrow-right"></span>
			</div>
		</div>
	</div>
	<div class="b b-main-about">
		<div class="b-wide-block b-margin">
			<div class="b-block">
				<div class="clearfix">
					<div class="b-main-text left">
						<h2 class="b-title">О нашей компании</h2>
						<div class="b-text">
							<p>«Томлесдрев» - крупнейшее лесоперерабатывающее предприятие Томской области, приоритетным направлением которого является комплексная переработка древесины:</p>
							<ul>
								<li>лесозаготовка;</li>
								<li>лесопиление;</li>
								<li>производство ДСП и ЛДСП.</li>
							</ul>
							<p>Рост и высокое качество продукции обеспечено за счет модернизации процесса производства, внедрения современных технологий, профессионализма сотрудников предприятия.</p>
						</div>
						<a href="about.php" class="b-orange-butt">Читать далее</a>
					</div>
					<div class="b-main-news right">
						<h2 class="b-three-color">Новости</h2>
						<ul>
							<li>
								<a href="#"><h3>Итоги осенних мебельных выставок</h3></a>
								<span class="b-date">09.10.2015</span>
								<p>В конце сентября и в первых числах октября предприятие "Томлесдрев" принимало...</p>
							</li>
							<li>
								<a href="#"><h3>Итоги осенних мебельных выставок</h3></a>
								<span class="b-date">09.10.2015</span>
	...
	<div class="b b-main-catalog">
		<div class="b-wide-block b-margin">
			<div class="b-block">
				<div class="clearfix">
					<h2 class="b-title left">Каталог декоров</h2>
					<a href="catalog.php" class="b-not-mobile b-orange-butt right">Все декоры</a>
				</div>
				<table class="b-catalog-accordeon clearfix">
					<tr>
						<td style="background-image: url('i/decor-1.jpg');">
							<div class="b-catalog-white">
								<p><b>Дуб Кобург</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						</td>
						<td style="background-image: url('i/decor-2.jpg');">
							<div class="b-catalog-white">
								<p><b>Дуб Кобург</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						</td>
						<td style="background-image: url('i/decor-3.jpg');">
							<div class="b-catalog-white">
								<p><b>Дуб Кобург</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						</td>
						<td style="background-image: url('i/decor-4.jpg');">
							<div class="b-catalog-white">
								<p><b>Дуб Кобург</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						</td>
						<td style="background-image: url('i/decor-5.jpg');">
							<div class="b-catalog-white">
								<p><b>Дуб Кобург</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						</td>
						<td style="background-image: url('i/decor-6.jpg');">
							<div class="b-catalog-white">
								<p><b>Дуб Кобург</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
				...
				<a href="catalog.php" class="b-mobile b-orange-butt b-accordeon-button">Все декоры</a>
			</div>
		</div>
	</div>
