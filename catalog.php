		...
		<div class="b-wide-block">
			<div class="b-slider">
				<div class="b-slide" data-parallax="scroll" data-image-src="i/catalog.jpg" >
					<div class="b-block">
						<h3>Большой выбор<br>разнообразных декоров</h3>
					</div>	
				</div>
			</div>
		</div>
	...
	<div class="b b-content">
		<div class="b-wide-block b-margin">
			<div class="b-block">
				...
				<h1 class="b-title">Каталог декоров лдсп</h1>
				<div class="b-text">
					<h2>Древесные</h2>
					<ul class="b-catalog clearfix">
						<li style="background-image: url('i/catalog/1.jpg');">
							<a href="i/catalog/1-b.jpg" rel="one" class="fancy-img-with-thumbs" title="Дуб Кобург"></a>
							<div class="b-catalog-white">
								<p><b>Дуб Кобург</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						</li>
						<li style="background-image: url('i/catalog/2.jpg');">
							<a href="i/catalog/2-b.jpg" rel="one" class="fancy-img-with-thumbs" title="Ясень Анкор Белый"></a>
							<div class="b-catalog-white">
								<p><b>Ясень Анкор Белый</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						</li>
						<li style="background-image: url('i/catalog/3.jpg');">
							<a href="i/catalog/3-b.jpg" rel="one" class="fancy-img-with-thumbs" title="Дуб Кобург"></a>
							<div class="b-catalog-white">
								<p><b>Дуб Кобург</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						</li>
						<li style="background-image: url('i/catalog/4.jpg');">
							<a href="i/catalog/4-b.jpg" rel="one" class="fancy-img-with-thumbs" title="Дуб Кобург"></a>
							<div class="b-catalog-white">
								<p><b>Дуб Кобург</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						</li>
						<li style="background-image: url('i/catalog/5.jpg');">
							<a href="i/catalog/5-b.jpg" rel="one" class="fancy-img-with-thumbs" title="Ясень Шимо Тёмный"></a>
							<div class="b-catalog-white">
								<p><b>Ясень Шимо Тёмный</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						</li>
						<li style="background-image: url('i/catalog/5.jpg');">
					...
					<ul class="b-catalog clearfix">
						<li style="background-image: url('i/catalog/1.jpg');">
							<a href="i/catalog/1-b.jpg" rel="two" class="fancy-img-with-thumbs" title="Дуб Кобург"></a>
							<div class="b-catalog-white">
								<p><b>Дуб Кобург</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						...
						<li style="background-image: url('i/catalog/2.jpg');">
							<a href="i/catalog/2-b.jpg" rel="two" class="fancy-img-with-thumbs" title="Ясень Анкор Белый"></a>
							<div class="b-catalog-white">
								<p><b>Ясень Анкор Белый</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						...
						<li style="background-image: url('i/catalog/3.jpg');">
							<a href="i/catalog/3-b.jpg" rel="two" class="fancy-img-with-thumbs" title="Дуб Кобург"></a>
							<div class="b-catalog-white">
								<p><b>Дуб Кобург</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						...
						<li style="background-image: url('i/catalog/4.jpg');">
							<a href="i/catalog/4-b.jpg" rel="two" class="fancy-img-with-thumbs" title="Дуб Кобург"></a>
							<div class="b-catalog-white">
								<p><b>Дуб Кобург</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
						...
						<li style="background-image: url('i/catalog/5.jpg');">
							<a href="i/catalog/5-b.jpg" rel="two" class="fancy-img-with-thumbs" title="Ясень Шимо Тёмный"></a>
							<div class="b-catalog-white">
								<p><b>Ясень Шимо Тёмный</b>Арт. 000000</p>
								<div class="b-three-color"></div>
							</div>
