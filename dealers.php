...
<body>
	...
	<div class="b-fixed-sides">
		<div class="b-fixed-side b-fixed-left">
			<div class="b-fixed-side-item" style="background-image: url('i/inner-blurred.jpg');"></div>
		</div>
	...
	<div class="b b-inner-slider">
		<div class="b-wide-block">
			<div class="b-slider">
				<div class="b-slide" data-parallax="scroll" data-image-src="i/ex/IMG_5233.jpg" >
					<div class="b-block">
						<h3>Наши дилеры по<br>всей стране</h3>
					</div>	
				</div>
			</div>
		</div>
	...
	<div class="b b-content">
		<div class="b-wide-block b-margin">
			<div class="b-block">
				...
				<h1 class="b-title">Карта дилеров</h1>
			</div>
			<div class="b-map-dealers" id="map-dealers"></div>
		</div>
	</div>
